...
Eleven specialized agents in `.github/agents/`:
...
#### 4. **DDD Agent** (`@ddd`) - Domain Modeling Specialist
- **Model**: Claude Opus 4.6
- **Tools**: Edit, search, Context7, DeepWiki, Microsoft Docs, Mermaid diagram tooling
- **Purpose**: Creates bounded-context proposals, domain models, and database diagrams
- **Instructions**: Produces `specs/domain/` artifacts including Mermaid domain and database diagrams

#### 5. **Architect Agent** (`@architect`) - Standards & Guidelines
- **Model**: Claude Opus 4.6
...
#### 6. **Planner Agent** (`@planner`) - Research & Planning
- **Model**: Claude Opus 4.6
...
#### 8. **Azure Agent** (`@azure`) - Cloud Architect
- **Model**: Claude Opus 4.6
...
#### 9. **Reverse Engineering Tech Analyst Agent** (`@tech-analyst`) - Technical Analyst
- **Model**: Claude Opus 4.6
...
#### 10. **Modernization Agent** (`@modernizer`) - Modernization Specialist
- **Model**: Claude Opus 4.6
...
#### 11. **Extension Agent** (`@extender`) - Feature Extension Specialist
